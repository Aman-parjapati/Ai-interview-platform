...
function Call({ interview }: InterviewProps) {
  ...
  useEffect(() => {
    ...
    // Load models from a public path or local directory
    const loadModels = async () => {
      const MODEL_URL = "/models"; // make sure your models are hosted here
  ...
  useEffect(() => {
    ...
    if (video && canvas) {
      ...
      intervalId = window.setInterval(async () => {
        ...
        // Clear canvas and draw detection box (optional)
        ...
        >
          <div className="text-center text-md font-semibold mr-2  ">
            ...
            <span className="font-bold">
              Aman<span className="text-indigo-600"> Info</span>
            </span>
          </div>
